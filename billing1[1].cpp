//Supermarket Billing System project in c++
#include<iostream>
#include<fstream>
...
if (email == "rashika@gmail.com" && password == "rashika@2002")
...
data1.open ("datadase1.txt", ios::app | ios::out);
...
cout << "\n\t\t\t____________________RECEIPT_____________\n";
